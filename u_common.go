...
import (
	...
	"github.com/malivvan/tls/internal/helper"
	"golang.org/x/crypto/cryptobyte"
)

// Naming convention:
// Unsupported things are prefixed with "Fake"
// Things, supported by utls, but not github.com/malivvan/tls' are prefixed with "utls"
...
const (
	utlsTypeEncryptedExtensions uint8 = 8 // implemention incomplete by github.com/malivvan/tls
...
// TLS
const (
	extensionNextProtoNeg uint16 = 13172 // not IANA assigned. Removed by github.com/malivvan/tls since Nov 2019
...
var (
	// HelloGolang will use default "github.com/malivvan/tls" handshake marshaling codepath, which WILL
