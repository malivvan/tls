...
import (
	...
	"github.com/malivvan/tls/internal/byteorder"
...
func TestHandshakeClientEd25519(t *testing.T) {
	t.Skip("TODO: currently not working because OpenSSL doesn't support Ed25519 certificates, but we should add this test once it does")
	test := &clientTest{
		name: "Ed25519",
...
func TestRSAPSSKeyError(t *testing.T) {
	// github.com/malivvan/tls does not support the rsa_pss_pss_* SignatureSchemes. If support for
