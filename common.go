...
import (
	...
	"github.com/malivvan/tls/internal/fips140tls"
)
...
type Config struct {
	...
	// certificate chain and host name. If InsecureSkipVerify is true, github.com/malivvan/tls
	...
	// github.com/malivvan/tls accepts the certificate even when it is expired.
	//
	...
	// If InsecureServerNameToVerify is "*", github.com/malivvan/tls will do normal
	...
	// returns (nil, nil), the session is ignored. github.com/malivvan/tls may still choose
