...
import (
	...
	"github.com/malivvan/tls/internal/tls12"
)
...
func noEKMBecauseRenegotiation(label string, context []byte, length int) ([]byte, error) {
	return nil, errors.New("github.com/malivvan/tls: ExportKeyingMaterial is unavailable when renegotiation is enabled")
}
...
func noEKMBecauseNoEMS(label string, context []byte, length int) ([]byte, error) {
	return nil, errors.New("github.com/malivvan/tls: ExportKeyingMaterial is unavailable when neither TLS 1.3 nor Extended Master Secret are negotiated; override with GODEBUG=tlsunsafeekm=1")
}
...
func ekmFromMasterSecret(version uint16, suite *cipherSuite, masterSecret, clientRandom, serverRandom []byte) func(string, []byte, int) ([]byte, error) {
	return func(label string, context []byte, length int) ([]byte, error) {
		...
		case "client finished", "server finished", "master secret", "key expansion":
			...
			return nil, fmt.Errorf("github.com/malivvan/tls: reserved ExportKeyingMaterial label: %s", label)
		}
		...
		if context != nil {
			if len(context) >= 1<<16 {
				return nil, fmt.Errorf("github.com/malivvan/tls: ExportKeyingMaterial context too long")
			}
