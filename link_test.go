...
import (
	...
	"github.com/malivvan/tls/testenv"
)

// Tests that the linker is able to remove references to the Client or Server if unused.
func TestLinkerGC(t *testing.T) {
	t.Skip("skipping until we can get this working with the new build system")
...
import _ "github.com/malivvan/tls"
func main() {}
`,
			bad: []string{
				"tls.(*Conn)",
				"type:github.com/malivvan/tls.clientHandshakeState",
				"type:github.com/malivvan/tls.serverHandshakeState",
			},
		},
		{
...
`,
			want: []string{
				"github.com/malivvan/tls.(*Conn).clientHandshake",
				"github.com/malivvan/tls.(*Conn).serverHandshake",
			},
		},
		{
			name: "only_client",
