...
// to perform TLS handshake using standard github.com/malivvan/tls implementation.
...
type CertificateRequestMsgTLS13 struct {
	// Deprecated: github.com/malivvan/tls no longer use this variable. This field won't be read or used by utls, but will still be populated.
	// Support may be removed in the future.
	Raw []byte
...
type PubServerHelloMsg struct {
	Raw                          []byte // renamed to serverHelloMsg.original in github.com/malivvan/tls
	Vers                         uint16
	Random                       []byte
	SessionId                    []byte
	CipherSuite                  uint16
...
type PubClientHelloMsg struct {
	Raw                          []byte // renamed to clientHelloMsg.original in github.com/malivvan/tls
	Vers                         uint16
	Random                       []byte
	SessionId                    []byte
	CipherSuites                 []uint16
