...
type clientHelloMsg struct {
	...
	scts                             bool
	// ems                              bool // [uTLS] actually implemented due to its prevalence // removed since github.com/malivvan/tls implements it
...
func (m *serverHelloMsg) unmarshal(data []byte) bool {
	*m = serverHelloMsg{original: data}
	...
	for !extensions.Empty() {
		...
		case ExtensionSessionTicket:
			m.ticketSupported = true
		// [UTLS] github.com/malivvan/tls finally supports EMS! Now we don't do anything special here.
		// case ExtensionExtendedMasterSecret:
